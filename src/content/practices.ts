...
export const PRACTICE_BACKS: Record<PracticeId, PracticeBack> = {
  engineering: {
    ...
    headline: "A foundation the business can trust",
    subhead: "The system behind numbers and products people rely on",
    body: "We take brittle pipelines and disputed sources and leave a foundation the team can operate — domains owned, quality visible, and handover explicit.",
    capabilities: [
      { label: "Sources", items: ["Source systems", "Existing platforms", "Business applications"] },
      { label: "Models", items: ["Business domains", "Owned definitions", "Trusted datasets"] },
      { label: "Serving", items: ["Reports", "Products", "Shared access"] },
      { label: "Reliability", items: ["Quality", "Monitoring", "Recovery", "Handover"] },
    ],
  },
  analytics: {
    ...
    body: "We turn competing numbers into one shared view of the business — so the room can measure what matters, see what is changing and decide with confidence.",
    capabilities: [
      { label: "Define", items: ["Shared KPIs", "Named metrics", "Owned definitions"] },
      { label: "Understand", items: ["Operating packs", "Analysis", "Reporting"] },
      { label: "Anticipate", items: ["Forecasts", "Scenarios", "Trends"] },
      { label: "Improve", items: ["Experiments", "Review cadence", "Outcomes"] },
    ],
  },
  ai: {
    kicker: "03 — AI & automation",
    headline: "What makes work reliable",
    subhead: "From repeated judgement to a process the team can run",
    body: "We take one high-volume process and put it on a governed path — grounded in your knowledge, reviewed by a named person, with a safe fallback when it is unsure.",
    capabilities: [
      { label: "Judgement", items: ["Classification", "Prediction", "Exceptions"] },
      { label: "Knowledge", items: ["Knowledge in context", "Search", "Grounded answers"] },
      { label: "Workflow", items: ["Assistants", "Existing tools", "Human review"] },
      { label: "Control", items: ["Evaluation", "Monitoring", "Safe fallback"] },
    ],
  },
  products: {
    ...
    body: "We ship the first slice people will actually open — usually replacing a workbook or a broken hand-off — connected to real data and the systems the business already runs.",
    capabilities: [
      { label: "Shape", items: ["Discovery", "Scope", "First journey"] },
      { label: "Applications", items: ["Internal tools", "Customer-facing slices", "Portals"] },
      { label: "Build", items: ["Real data", "Enterprise systems", "Working software"] },
      { label: "Run", items: ["Live in production", "Improve from use", "Handover"] },
    ],
  },
};
